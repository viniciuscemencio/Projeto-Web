    ...
    <div class="blog-comments container">
        <?php if (have_comments() && comments_open()) : ?>
            ...
            <?php $comments_arg = array(
                ...
                'title_reply_beforce' => '<h6 id="reply-title" class="comment-reply-title mt-4">',
                ...
                'comment_field' => '<p>' . '<textarea id="comment" class="form-control" placeholder="Sua Mensagem..." name="comment" rows="3"  aria-required="true"></textarea>' . '</p>',                  
                'comment_notes_after' => '',
